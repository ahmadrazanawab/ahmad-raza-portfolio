...
const timelineData: TimelineItem[] = [
    {
        ...
        desc: "Worked as a Full Stack Developer, developing and maintaining web applications using React.js, Next.js, TypeScript, Tailwind CSS, Node.js, Express.js, MongoDB, and REST APIs.",
        type: "work",
        icon: Briefcase,
    },
    {
        ...
        org: "Dr. P. A. Inamdar University, Pune",
        desc: "Currently pursuing MCA and strengthening skills in software development, databases, data structures, system design, and modern web technologies.",
        type: "education",
        icon: BookOpen,
    },
    {
        ...
        desc: "Completed BCA with a foundation in programming, database management, data structures, web development, and software engineering.",
        type: "education",
        icon: Award,
    },
    {
        ...
        desc: "Completed Higher Secondary education with a foundation in mathematics, computer science, and general academic studies.",
        type: "education",
        icon: Award,
    },
    {
        ...
        desc: "Completed secondary education and built a strong foundation for higher studies.",
        type: "education",
        icon: Award,
    },
];
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute left-6 md:left-1/2 top-6 w-12 h-12 -translate-x-1/2 z-20">
                                        <div
                                            className={`w-12 h-12 rounded-full bg-gradient-to-br ${item.type === "work"
                                                    ? "from-blue-500 to-blue-600"
                                                    : "from-purple-500 to-pink-500"
                                                } flex items-center justify-center shadow-lg transition-all duration-300 ${hoveredIndex === index ? "scale-125 shadow-2xl" : ""
                                                }`}
                                        >
                                    ...
                                    {/* Content */}
                                    <div
                                        className={`ml-20 md:ml-0 md:w-1/2 ${isLeft
                                    ...
                                    >
                                        <div
                                            className={`bg-gradient-to-br ${item.type === "work"
                                                ...
                                                } border rounded-xl p-6 transition-all duration-300 hover:shadow-2xl ${hoveredIndex === index
                                        ...
                                        >
                                            ...
                                            {/* Accent line */}
                                            <div
                                                className={`h-0.5 mt-4 transition-all duration-300 ${hoveredIndex === index ? "w-full" : "w-0"
                                                    } bg-gradient-to-r ${item.type === "work"
